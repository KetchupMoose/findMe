                       ...
                       withParameters:@{@"payload": xmlGeneratedString}
                                block:^(NSString *responseString, NSError *error) {
                                    ...
                                    else
                                    {
                                        ...
                                        UIAlertView *n2 = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"submitXML Error N2", nil) message:@"Error Code N2" delegate:self cancelButtonTitle:NSLocalizedString(@"OK", nil) otherButtonTitles:nil];
                                        n2.tag = 101;
                                        [n2 show];
